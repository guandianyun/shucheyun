...
public  class CommonConfig extends JFinalConfig {
	...
	public static String weixinDomain; // 微信域名
	...
	public static String systemName = "数车云"; // 系统名称
	public static String ehrJiangxiErpcode = ""; // 江西电子健康档案软件公司ERPcode
	public static String platformCode = ""; // 平台标识，用于区分当前部署的是哪个地区的平台
	
	public static String baiduIdentifyOCRAppid = ""; // 百度AI appid
	public static String baiduIdentifyOCRApikey = ""; // 百度AI密钥
	public static String baiduIdentifyOCRSecretkey = ""; // 百度AI密钥
	...
	public void configConstant(Constants me) {
		...
		systemName = getProperty("system.name");
		pcWebDomain = getProperty("pc.web.domain");
		weixinDomain = getProperty("weixin.domain");
		...
		ehrJiangxiErpcode = getProperty("ehr.jiangxi.erpcode");
		
		platformCode = getProperty("platform.code");
		
		baiduIdentifyOCRApikey = getProperty("baiduIdentifyOCR.apikey");
		baiduIdentifyOCRSecretkey = getProperty("baiduIdentifyOCR.secretkey");
		baiduIdentifyOCRAppid = getProperty("baiduIdentifyOCR.appid");
