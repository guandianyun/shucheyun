 ...
 * 
 */
package com.bytechainx.digauto.common.api;
...
import com.bytechainx.digauto.common.CommonConfig;
...
public class TraderCenterApi {
	 ...
	 * @return
	 */
	public static String requestApi(String api, Integer tenantOrgId, Integer adminId, Map<String, String[]> params) {
		try {
			...
			_params.put("tenant_org_id", tenantOrgId+"");
	...
	public static String requestApix(String api, Integer tenantOrgId, Integer adminId, Map<String, Object> params) {
		try {
			String randomCode = RandomUtil.genRandomNum(5);
			long currentTime = System.currentTimeMillis();
			String signature = DigestUtils.md5Hex(randomCode+currentTime+CommonConfig.traderApiSecret); // 签名
			...
			params.put("tenant_org_id", tenantOrgId+"");
